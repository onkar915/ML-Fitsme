    ...
    var i =
        "clippingParents" === e
          ? (function (t) {
              var e = Ut(Et(t)),
                n =
                  ["absolute", "fixed"].indexOf(bt(t).position) >= 0 && pt(t) ? kt(t) : t;
              return ht(n)
                ? e.filter(function (t) {
      ...
      return (
        ...
        (o.dataApiKeydownHandler = function (t) {
          if (
            ...
            if (n && "Space" !== t.key) {
              var i = q
                .find(".dropdown-menu .dropdown-item:not(.disabled):not(:disabled)", e)
                .filter(g);
              if (i.length) {
        ...
        (r._resetScrollbar = function () {
          q
            ...
            .forEach(function (t) {
              ...
              void 0 !== e &&
                (Y.removeDataAttribute(t, "padding-right"), (t.style.paddingRight = e));
            }),
            q.find(".sticky-top").forEach(function (t) {
              var e = Y.getDataAttribute(t, "margin-right");
              void 0 !== e &&
                (Y.removeDataAttribute(t, "margin-right"), (t.style.marginRight = e));
            });
        ...
        a = function (t, n) {
          ...
          l.forEach(function (t) {
            (function (t, e) {
              ...
              if (e.includes(n))
                return (
                  !Ae.has(n) || Boolean(t.nodeValue.match(Ce) || t.nodeValue.match(De))
                );
              for (
      ...
      return (
        ...
        (o.jQueryInterface = function (t) {
          return this.each(function () {
            ...
            if (
              (e || (e = new o(this, "object" == typeof t && t)), "string" == typeof t)
            ) {
              if (void 0 === e[t]) throw new TypeError('No method named "' + t + '"');
              e[t]();
            }
